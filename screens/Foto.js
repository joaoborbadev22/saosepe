...
import FotoFlat from '../components/Flatlist/FotoFlat';
        ...
        <ScrollView>
          <View style={styles.container}>
                <View style={styles.header}>
                    <Image style={{width:"100%",height:"100%"}} source={require('../src/Fotos.png')}/>
                </View>
                <View style={{marginVertical:20}}>
                    <Text style={{fontFamily:'Poppins_400Regular',paddingHorizontal:15,paddingTop:15,fontSize:17}}>Viaje por São Sepé sem sair de casa:</Text>
                    <FotoFlat />
                </View>
                <View  style={{marginVertical:20}}>
                    <Text style={{fontFamily:'Poppins_400Regular',paddingHorizontal:15,paddingTop:15,fontSize:17}}>Saiba as historias por trás de nossas Fotografias:</Text>
                    <HistModule />
                </View>
          </View>
        </ScrollView>
