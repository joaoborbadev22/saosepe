...
import MapFlat from '../components/Flatlist/MapFlat';
    ...
    return(
        <SafeAreaView   style={styles.container}>
            <View style={styles.header}>
                <Image style={{width:"100%",height:"100%"}} source={require('../src/praça.png')}/>
            </View>
            <View>
              <View style={{justifyContent:'flex-start',padding:10}}>
                <Text style={{fontSize:23,fontFamily:'Poppins_600SemiBold',}}>Nossa História</Text>
              </View>
              <HistModule/>
            </View>
            <View>
              <View style={{justifyContent:'flex-start',padding:10}}>
                <Text style={{fontSize:19,fontFamily:'Poppins_600SemiBold',}}>Pontos históricos</Text>
              </View>
              <MapFlat navigation={navigation}/>
            </View>
        </SafeAreaView>
    );
}
