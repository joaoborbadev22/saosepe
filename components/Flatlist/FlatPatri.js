            ...
            renderItem={({item})=> 
              (
                <View style={{
                  ...
                  >
                  <Pressable onPress={()=> modalfr(item.id)} style={{height:'100%',justifyContent:'center',alignItems:'center',position:'relative'}}><Image style={{width:"100%",height:"100%",borderRadius: 12,}} source={require('../../src/busto.webp')}/></Pressable>
                </View>
              ) 
            }
          />
