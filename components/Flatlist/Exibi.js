...
import {StyleSheet, View, Text, FlatList, Dimensions,Image, Pressable,Modal,ScrollView } from 'react-native';
...
const Users = props => {
    ...
    getUsers = () => {
        fetch('http://env-9593657.jelastic.saveincloud.net/exibi')
                        ...
                        renderItem={({item})=>
                            (
                                <>
                                    ...
                                    ><Text style={styles.EducationTitle}>{Moment(item.data).format('D/M/YYYY,  h:mm ')}</Text>
